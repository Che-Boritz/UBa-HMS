...
<!-- Mirrored from www.wrappixel.com/demos/admin-templates/material-pro/minisidebar/app-chat.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 11 Feb 2019 11:12:33 GMT -->
<head>
    <meta charset="utf-8">
                ...
                <div class="row page-titles">
                    ...
                    <div class="align-self-center col-md-4 ">
                        <div class="col-md-5  two-btn">
                            <a href="../minisidebar/index4.html" button type="button" class="btn waves-effect waves-light btn-block btn-info">Home</a>
                        </div>
                        <div class="col-md-6 two-btn">
                            <a href="../minisidebar/form-layout.html"button type="button" class="btn waves-effect waves-light btn-block btn-info">New Session</a>
                        </div>
                    </div>
