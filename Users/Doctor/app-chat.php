                ...
                <div class="row page-titles">
                    ...
                    <div class="align-self-center col-md-4 ">
                        <div class="col-md-5  two-btn">
                            <a href="doctor consultation.html" button type="button" class="btn waves-effect waves-light btn-block btn-info">Home</a>
                        </div>
                        <div class="col-md-6 two-btn">
                            <a href="#"button type="button" class="btn waves-effect waves-light btn-block btn-info">New Session</a>
                        </div>
                    </div>
                                ...
                                <div class="chat-left-aside">
                                    ...
                                    <div class="chat-left-inner">
                                        ...
                                        <ul class="chatonline style-none ">
                                            ...
                                            <li>
                                                <a href="javascript:void(0)" class="active"><img src="<?php echo base_url(); ?>assets/images/users/2.jpg" alt="user-img" class="img-circle"> <span>Genelia Deshmukh <small class="text-warning">Away</small></span></a>
                                            </li>
                                            <li>
                                    ...
                                    <div class="chat-rbox">
                                        <ul class="chat-list p-20">
                                            ...
                                            <li class="reverse">
                                                ...
                                                <div class="chat-img"><img src="<?php echo base_url(); ?>assets/images/users/5.jpg" alt="user" /></div>
                                            </li>
                                            <!--chat Row -->
                                            <li class="reverse">
                                                <div class="chat-time">10:57 am</div>
