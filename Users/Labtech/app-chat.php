...
<head>
    ...
    <title>Lab-Tech Dashboard</title>
    <!-- Bootstrap Core CSS -->
    ...
    <div id="main-wrapper">
        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                <!-- User profile -->
                <div class="user-profile" style="background: url(../assets/images/background/) no-repeat;">
                    <!-- User profile image -->
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="waves-effect waves-dark" href="lab-tech index.html" aria-expanded="false"><i class="fas fa-home"></i><span> Home </span></a>
                        </li>
                        <li> <a class="waves-effect waves-dark" href="consultation.html" aria-expanded="false"><i class="fas fa-ambulance"></i><span> Outpatient </span></a>
                            
                        </li>
                        <li> <a class="waves-effect waves-dark" href="app-chat.html" aria-expanded="false"><i class="ti-themify-favicon-alt"></i> <span> Chat app </span></a>
                        </li>
                    </ul>
                </nav>
                ...
                <div class="row page-titles">
                    ...
                    <div class="align-self-center col-md-4 ">
                        <div class="col-md-5  two-btn">
                            <a href="lab-tech index.html" button type="button" class="btn waves-effect waves-light btn-block btn-info">Home</a>
                        </div>
                        <div class="col-md-5  two-btn">
