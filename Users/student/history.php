						...
						<div class="col-md-12">
							<div class="profile-header">
								<div class="row align-items-center">
									...
									<div class="col ml-md-n2 profile-user-info">
										<h4 class="user-name mb-0">	Ngwa Brine</h4>
										<h6 class="text-muted">Faculty of Law and Political Sciences</h6>
							...
							<div class="profile-menu">
								<ul class="nav nav-tabs nav-tabs-solid">
									<li class="nav-item">
										<a class="nav-link active" data-toggle="tab" href="#per_details_tab">Consultation History</a>
									</li>
									<li class="nav-item">
										<a class="nav-link" data-toggle="tab" href="#password_tab">Medical History</a>
									</li>
								</ul>
							</div>	
